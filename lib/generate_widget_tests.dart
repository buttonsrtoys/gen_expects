...
/// [rootWidgetType] is the type of test app. This is used as the root to generate expects.
...
Future<void> genExpects(
  ...
  Type rootWidgetType = MaterialApp,
  bool silent = false,
  bool showTip = true,
...
Future<List<String>> genExpectsOutput(
  ...
  try {
    find.byType(rootWidgetType);
    context = tester.element(find.byType(rootWidgetType));
  } catch (e) {
    // If here, the user probably forgot 'await' and the tester widget tree was deleted by the time this find
    // was performed.
    text.add(
      'No ancestors found of type $rootWidgetType at the top of the widget tree. Did you forget "await" before '
      '"dumpWidgets"?',
    );
    return text;
  }
